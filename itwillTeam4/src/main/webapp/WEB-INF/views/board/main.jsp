...
<body>
	...
	<div class="container-fluid">
		...
		<nav>
			<!-- 메뉴 -->
			<ul>
				<li><a href="../" type="button">메인</a></li>
				<li><a href="./insert" type="button">새 글 작성</a></li>
			</ul>
		</nav>
			...
			<table>
				...
				<tbody>
					<c:forEach var="board" items="${boardList}">
						<tr>
							<td>${board.bno}</td>
							<td><a href="./detail?bno=${board.bno}">${board.board_title}</a>
							</td>
							<td>${board.board_userid}</td>
							<td><fmt:formatDate value="${board.board_reg_date}"
