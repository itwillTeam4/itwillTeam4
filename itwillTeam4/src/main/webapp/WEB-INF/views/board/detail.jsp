				...
				.ready(
													...
													$(respText)
															.each(
																	function() {
																		...
																		var date = new Date(
																				this.reply_reg_date); // JavaScript Date 객체 생성
																		var dateStr = date
																				.toLocaleDateString()
																				+ ' '
																				+ date
         		   ...
         		   + '" readonly />'
							...
							$('#replies')
									.on(
											'click',
											'.reply_item .reply_update',
											function() {

												var rno = $(this).prevAll(
														'#rno').val();
												var rtext = $(this).prevAll(
														'#rtext').val();
							...
							$('#replies')
									.on(
											'click',
											'.reply_item .reply_delete',
											function(event) {
												var rno = $(this).prevAll(
														'#rno').val();
												var result = confirm(rno
														+ '번 댓글을 정말 삭제할까요?');
